...
public class Generator {
    ...
    // 根据命名规范，只修改此常量值即可
    private static String MODULE = "ai-dao-chat";
    private static String DATABASE = "ai";
    private static String TABLE_PREFIX = "t_ai_chat_sinogram";
    private static String PACKAGE_NAME = "com.hsy.ai.dao.chat" ;
